...
```bash
python scrapers/scrape\_fp\_dk\_salaries.py --week 1 --year 2026

flask load-weekly-salary data/fp\_dk\_salaries\_week1\_2026.csv.gz --year 2026   # live Slate page
